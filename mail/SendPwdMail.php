	...
	if($result > 0 ){
		...
		if($result > 0){
			...
			try {
				...
				$mail->Body    = "Hi:<br><br>This is your new password:  <b>" . $ramdowPwd . "</b><br> For your account safety, please login with the new password and change your password as soon as possible.<br><br>Please do not reply to this message; it was sent from an unmonitored email address and you will not receive a response";
				...
				header("Location: /signin_out_up/findPwd.php?info=发送失败，请联系客服帮您找回密码");
