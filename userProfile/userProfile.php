                            ...
                            <div class='col-md-4 margin-position-top padding-small'>
                                <div class='row'>
                                    <div class='col-md-12 form-group inner-group flexbox-center'>
                                        ...
                                        <div class='col-sm-5 inner-textfield'>
                                            <input type='' name='userNamef' id='userNamef' placeholder='' class='form-control label-info-position margin-left-zero label-style1'  value='" . $result['userName'] . "' maxlength='30'>
                                        </div>
                                    </div>
                                </div>
                                <div class='row'>
                                    <div class='col-md-12 form-group inner-group flexbox-center'>
                                        ...
                                        <div class='col-sm-5 inner-textfield'>
                                            <input type='' name='phonef' id='phonef' placeholder='' class='form-control label-info-position margin-left-zero label-style1'  value='" . $result['phoneNumber'] . "' maxlength='20'>
                                        </div>
                                    </div>
                                </div>
                                <div class='row'>
                                    <div class='col-md-12 form-group inner-group flexbox-center'>
                                        ...
                                        <div class='col-sm-5 inner-textfield'>
                                            <input type='' name='wechatf' id='wechatf' placeholder='' class='form-control label-info-position margin-left-zero label-style1'  value='" . $result['weChatNumber'] . "' maxlength='20'>
                                        </div>
                                    </div>
                                </div>                           
                            </div> 
