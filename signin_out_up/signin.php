...
<div class='row signup-container'>
		...
		<form class="form-signin" action="php/SignIn.php" method="POST" >
			<h1 class="h3 mb-3 font-weight-normal" style="text-align: center;">登录</h1>
			<?php
				extract ($_GET);
				if(isset($info)){
			...
			<button class="btn btn-lg btn-primary btn-block login-signup-button" type="submit" style="width: 100px; margin: 20px auto 20px auto; padding: 4px">登录</button> 
